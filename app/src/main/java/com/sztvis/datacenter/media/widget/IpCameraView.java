package com.sztvis.datacenter.media.widget;
...
import com.sztvis.datacenter.model.AuthInfo;
import com.sztvis.datacenter.model.Profile;
import com.sztvis.datacenter.utils.IpcUtils;
import com.sztvis.datacenter.utils.XmlParserUtils;
...
public class IpCameraView extends FrameLayout {
    ...
    private void init(Context context) {
        ...
        tabLayout.setBackgroundColor(0x0000000);
    ...
    public Bitmap screenShot2(){
        return mIjkVideoView.getShortcut();
    }
}
